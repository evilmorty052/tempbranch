...
export function MenuItem({func, itemHeader, itemSubtext, list, buttonText, children, switcher}) {
    return (
      <>
      <div className='slide-in-right col-span-2 sm:pr-10 md:pr-20'>
       <div className=' flex items-center gap-x-8 px-4  pb-6'>
        ...
        >
          <div className="flex-shrink-0 flex-grow-1 flex min-w-0 min-h-0 p-0 m-0 relative z-0 align-center justify-between max-w-md">
