...
const { logout, currentUser } = useAuth()
  ...
  return (
    <Popover className="relative">
      <Popover.Button className={` text-xl text-green-300  font-poppins font-bold gap-4 mx-2`}><span className='flex items-center bg-transparent px-2 py-1 rounded-lg' >Invest<ChevronDownIcon
