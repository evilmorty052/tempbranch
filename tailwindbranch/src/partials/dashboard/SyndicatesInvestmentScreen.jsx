...
const SyndicatesInvestmentScreen = () => {
  const Syndicatecard = ({syndicatename, rating, subtitle }) => {
    return(
        <>
        <motion.a whileTap={{scale: 2}} transition={{duration: 0.5 }}
  href="#"
...
>
  <div   initial={{opacity:0}} animate={{opacity: 1}} class="absolute inset-0 bg-black/25"></div>

  <div class="relative flex items-start justify-between p-4 sm:p-6 lg:p-8">
    <div class="sm:pt-18 pt-12 text-white lg:pt-24">
      <h3 class="text-xl font-bold sm:text-2xl">{syndicatename}</h3>
  ...
  <div className="absolute top-3.5 left-4">
    <h3 className="text-white font-bold text-base">ROI: 4%</h3>
  </div>
</motion.a>
  ...
  return (
    <div className="py-8">
       <div className="px-2 max-w-sm">
            <Syndicatecard syndicatename={'ChromaConclave'} subtitle='1200 followers' rating={'4.4'}/>
       </div>
    </div>
  )
}
