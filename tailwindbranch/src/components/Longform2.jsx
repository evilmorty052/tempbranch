...
function handleSubmit(e) {
     e.preventDefault()
    if(!firstname|| !lastname || !email || !password || !passwordref ){
     message.error('Please Fillout All Fields Marked As Required')
     return
    }

    else if(password != passwordref){
       ...
       register(email, password).then((res)=>{
         res && history('/register/registerpage3')
       }).catch((err)=>{
  ...
  <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
    ...
    >
      <div class="max-w-xl lg:max-w-3xl">
        ...
        >
          Hi {firstname}{wave && <Waver/>}
        </h1>

        <p class="mt-4 leading-relaxed text-gray-500">
        We need some basic information to set up your investment account
        </p>
